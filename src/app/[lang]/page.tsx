              ...
              {[
                {
                  ...
                  title: dict.home.experience,
                  desc: dict.home.experienceDesc
                },
                {
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  title: dict.home.ownFactory,
                  desc: dict.home.ownFactoryDesc
                },
                {
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                },
                {
                  ...
                  title: dict.home.globalShipping,
                  desc: dict.home.globalShippingDesc
                },
              ].map((item, index) => (
