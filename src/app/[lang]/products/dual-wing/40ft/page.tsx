...
export default async function DualWing40ftPage({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  const d = getDict(lang).dualWing40
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-12 md:py-20">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold text-white mb-10 tracking-tight">{d.title}<span className="text-gray-500 font-normal ml-2">40ft</span></h1>
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          <div className="lg:w-2/5 space-y-4">
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/dual-wing-40ft-square.jpg" alt="40ft" width={800} height={800} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/dual-wing-40ft-tall.jpg" alt="40ft Side" width={800} height={1000} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
          </div>
          <div className="lg:w-3/5">
            <div className="card-dark rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-0">
                {[['Folding Mechanism', d.foldingMech],['Main Frame', d.frame],['Walls', d.walls],['Windows', d.windows],['Flooring', d.flooring],['Kitchen', d.kitchen],['Bathroom', d.bathroom],['Electrical & Plumbing', d.electrical]].map(([k,v])=>(
