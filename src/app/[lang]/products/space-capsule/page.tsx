...
export default async function SpaceCapsulePage({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  const d = getDict(lang).spaceCapsule
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          <div className="lg:w-2/5 space-y-4">
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/space-capsule-square.jpg" alt={d.title} width={800} height={800} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/space-capsule-tall.jpg" alt={d.title} width={800} height={1000} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
          </div>
