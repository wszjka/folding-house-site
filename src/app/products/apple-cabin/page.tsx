    ...
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-12 md:py-20">
        ...
        <div className="flex items-baseline gap-4 mb-3">
          <h1 className="text-3xl md:text-4xl font-semibold text-white tracking-tight">Apple Cabin</h1>
        </div>
        <p className="text-gray-400 mb-10 max-w-2xl leading-relaxed">
          Curved dome design with panoramic floor-to-ceiling windows, high-strength galvanized steel frame, wind resistance grade 12, optional smart home system.
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="lg:w-2/5 space-y-4">
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/apple-cabin-square.jpg" alt="Apple Cabin" width={800} height={800} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/apple-cabin-tall.jpg" alt="Apple Cabin Side" width={800} height={1000} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
          </div>
          ...
          <div className="lg:w-3/5">
            <div className="card-dark rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-0">
                {[['20FT','L5800 x W2200 x H2450MM · 4 tons · 13sqm'],['30FT','L9000 x W2200 x H2450MM · 6 tons · 19.8sqm'],['40FT','L11500 x W2200 x H2450MM · 8 tons · 26sqm'],['Layout','1-2 bedroom, living room, kitchen & bathroom']].map(([k,v])=>(
