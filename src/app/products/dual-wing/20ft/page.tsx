...
export default function DualWing20ftPage() {
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-12 md:py-20">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold text-white mb-10 tracking-tight">
          Dual-Wing Folding House<span className="text-gray-500 font-normal ml-2">20ft</span>
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="lg:w-2/5 space-y-4">
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/dual-wing-20ft-square.jpg" alt="Dual-Wing 20ft" width={800} height={800} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
            <div className="card-dark rounded-xl overflow-hidden">
              <Image src="/images/products/dual-wing-20ft-tall.jpg" alt="Dual-Wing 20ft Side" width={800} height={1000} className="w-full object-contain" style={{maxHeight: 420}} />
            </div>
          </div>
          ...
          <div className="lg:w-3/5">
            <div className="card-dark rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-0">
                {[['Size','L6000 x W2500 x H2500MM'],['Weight','5 tons'],['Area','15sqm (folded) / 30sqm (expanded)'],['Layout','1-2 bedroom, kitchen, bathroom']].map(([k,v])=>(
